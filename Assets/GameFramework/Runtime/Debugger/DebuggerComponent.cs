...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        private void DrawDebuggerWindowGroup(IDebuggerWindowGroup debuggerWindowGroup)
        {
            ...
            int toolbarIndex = GUILayout.Toolbar(debuggerWindowGroup.SelectedIndex, names.ToArray(), GUILayout.Height(50f), GUILayout.MaxWidth(Screen.width));
        ...
        private void DrawDebuggerWindowIcon(int windowId)
        {
            ...
            if (GUILayout.Button(title, GUILayout.Width(100f), GUILayout.Height(60f)))
            {
